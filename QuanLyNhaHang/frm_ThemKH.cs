...
namespace QuanLyNhaHang
{
    public partial class frm_ThemKH : Form
    {
        ...
        private void lbl_XacNhan_Click(object sender, EventArgs e)
        {
            ...
            if (txt_HoTen.Text != "" && txt_SDT.Text != "" && txt_DiaChi.Text != "")
            {
                if (dt.KiemTraTrung_SDTKH(txt_SDT.Text))
                {
                    if (dt.ThemKH("123",txt_HoTen.Text, rdo_Checked, txt_DiaChi.Text, txt_SDT.Text, txt_TheTV.Text, int.Parse(txt_DiemTL.Text)))
                    {
